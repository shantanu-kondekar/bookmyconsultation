...
public class AppointmentController {
	...
	//create a method post method named bookAppointment with return type ResponseEntity
		...
		String savedAppointmentID = appointmentService.acceptAppointment(appointment);
	...
	//create a get method named getAppointment with return type as ResponseEntity
		...
		public ResponseEntity getAppointment(@PathVariable(name= "appointmentId") String appointmentId){
			System.out.println("in Get Appointment");
			Appointment foundAppointment = appointmentService.getAppointment(appointmentId).get();
			System.out.println(foundAppointment);
			return new ResponseEntity(foundAppointment, HttpStatus.FOUND);
		}
